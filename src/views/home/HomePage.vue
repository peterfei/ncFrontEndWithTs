<template>
  <div class="home-page">
    ...
    <div class="content">
      ...
      <div class="ad-item">
        <ad-item :item="item" v-for="item in homeAd" :key="item.id"></ad-item>
      </div>
      <row-title
        row-icon="icon-mima2"
        row-title="热门活动"
      ...
      <div v-if="homeAdActive.length > 0">
        ...
        >
          <template slot-scope="item">
            <ad-item :item="item.row" width="590px" height="240px"></ad-item>
          </template>
        </carousel-more>
      </div>
      <div v-else class="no-data">
    ...
    <div class="sch-inner">
      <div class="content">
        ...
        <div v-if="schInner.length > 0">
          <carousel-more :carouselLists="schInner" :show-num="1" height="230px">
            <template slot-scope="item">
              <sch-inner
