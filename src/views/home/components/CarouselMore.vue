<template>
    <div class="carousel-more">
        ...
        >
            <el-carousel-item
                v-for="(itemlist, index) in carouselList"
                :key="index"
            >
...
export default class CarouselMore extends Vue {
    ...
    // 计算属性的 getter
    get carouselList() {
        // alert(`carouselLists is ${this.carouselLists}`)
        const carouselItem = []
        let i = 0
    ...
    // public carousel: any = this.$refs.carousel
    public ibdPrev(): void {
