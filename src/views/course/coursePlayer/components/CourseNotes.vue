  ...
  <div class="course-notes">
      ...
      >
        ...
        <el-form-item>
          <div class="switch-button">
            <span>
              <snap-shoted-switch
                @snapShotedSwitch="snapShotedSwitch"
              ></snap-shoted-switch>
            </span>
            <div>
              <el-button size="mini" round @click="subResetForm('subForm')"
                >取消</el-button
              >
              <el-button
                type="primary"
    ...
    <div class="notes-list">
      <div class="notes-list-scroll" id="notes-list-scroll">
        <h5>我的笔记</h5>
        <div class="notes-card" v-for="item in noteLists" :key="item.id">
          <el-card>
            <div class="notes-text">{{ item.content }}</div>
            <div class="notes-img" v-if="item.snapshot">
              <img :src="item.snapshot" alt="" />
              <span>
                {{ Math.round(item.time_point) | getTimer('xx:xx') }}</span
              >
            </div>
